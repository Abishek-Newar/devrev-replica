...
const content = [
  {
    ...
    content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image
          src="https://cdn.sanity.io/images/umrbtih2/production/dd60f0a4b9ffdb0e655a4d098cff039b6bde5b9d-420x359.svg"
          width={300}
          height={300}
  ...
  },
  {
    ...
    content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image
          src="https://cdn.sanity.io/images/umrbtih2/production/d6892d864a8712b17745e02e92a7af8d81892d04-420x349.svg"
          width={300}
          height={300}
          className="h-full w-full object-cover"
          alt="linear board demo"
